...
int32_t catalogGetExpiredDBs(SCatalog* pCtg, SDbCacheVersion** dbs, uint32_t* num) {
  CTG_API_ENTER();
  ...
  CTG_API_LEAVE(ctgMetaRentGet(&pCtg->dbRent, (void**)dbs, num, sizeof(SDbCacheVersion)));
}
